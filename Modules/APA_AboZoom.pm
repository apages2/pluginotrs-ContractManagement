# --
# Kernel/Modules/APA_AboZoom.pm - frontend module
...
package Kernel::Modules::APA_AboZoom;
...
sub Run {
	...
	my $ContractManagement = $Kernel::OM->Get('Kernel::System::Exaprobe::APA_AboZoom');
	...
	if ( $Self->{Subaction} eq 'AJAXClickBoutonAdd' ) {
		...
		$Output .= $LayoutObject->Output(
            Data => \%Data,
			TemplateFile => 'Exaprobe/APA_AboZoom',
        );
