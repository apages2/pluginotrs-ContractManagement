...
package Kernel::Modules::CustomerDynamicFieldDatabaseDetailedSearch;
...
sub Run {
    ...
    if ( $Self->{Subaction} eq 'DetailedSearch' ) {
        ...
        if (%SearchAttributes) {
            ...
            %Result = $DynamicFieldDatabaseObject->DatabaseSearchByAttributes(
    ...
    $Output .= $LayoutObject->Output(
        TemplateFile => 'CustomerDynamicFieldDatabaseDetailedSearch',
        Data         => {
            %Param,
            DynamicFieldName => $DynamicFieldName,
            }
