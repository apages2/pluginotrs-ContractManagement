...
sub Load {
    my ($File, $Self) = @_;
$Self->{'Ticket::EventModulePost'}->{'500-NotificationEventContacts'} =  {
  'Event' => '',
  'Module' => 'Kernel::System::Ticket::Event::NotificationEventContacts',
  'Transaction' => '1'
};
$Self->{'CustomContactFieldsRestrictContactsToCustomerOnly'} =  '1';
$Self->{'CustomContactFieldsSendJoinedNotification'} =  '1';
$Self->{'CustomContactFieldsEmailInsertAfter'} =  '#ToCustomer';
$Self->{'Frontend::Output::FilterElementPost'}->{'OTRSCustomContactFieldsTicketCustomer'} =  {
  'Debug' => '1',
  'Module' => 'Kernel::Output::HTML::FilterElementPost::OTRSCustomContactFieldsTicketCustomer',
  'Templates' => {
    'AgentTicketCustomer' => '1'
  }
};
$Self->{'Frontend::Output::FilterElementPost'}->{'OTRSCustomContactFieldsTicketCompose'} =  {
  'Debug' => '1',
  'Module' => 'Kernel::Output::HTML::FilterElementPost::OTRSCustomContactFieldsTicketCompose',
  'Templates' => {
    'AgentTicketCompose' => '1'
  }
};
$Self->{'Frontend::Output::FilterElementPost'}->{'OTRSCustomContactFieldsAdminNotificationEvent'} =  {
  'Debug' => '1',
  'Module' => 'Kernel::Output::HTML::FilterElementPost::OTRSCustomContactFieldsAdminNotificationEvent',
  'Templates' => {
    'AdminNotificationEvent' => '1'
  }
};
$Self->{'Frontend::Output::FilterElementPost'}->{'OTRSCustomContactFieldsTicketZoom'} =  {
  'Debug' => '1',
  'Module' => 'Kernel::Output::HTML::FilterElementPost::OTRSCustomContactFieldsTicketZoom',
  'Templates' => {
    'AgentTicketZoom' => '1',
    'CustomerTicketZoom' => '1'
  }
};
$Self->{'Frontend::Template::GenerateBlockHooks'}->{'900-OTRSCustomContactFields-TicketZoom'} =  {
  'AgentTicketZoom' => [
    'LinkTableSimple',
    'CustomerTable'
  ],
...
$Self->{'Frontend::Output::FilterElementPost'}->{'OTRSCustomContactFieldsJS'} =  {
  'Debug' => '1',
  'Module' => 'Kernel::Output::HTML::FilterElementPost::OTRSCustomContactFieldsJS',
  'Templates' => {
    'AdminGenericAgent' => '1',
...
$Self->{'Frontend::Output::FilterElementPost'}->{'OTRSCustomContactFieldsSimpleWidget'} =  {
  'Debug' => '1',
  'Module' => 'Kernel::Output::HTML::FilterElementPost::OTRSCustomContactFieldsSimpleWidget',
  'Templates' => {
    'AgentTicketEmail' => '1',
    'AgentTicketPhone' => '1',
    'AgentTicketPhoneCommon' => '1'
...
$Self->{'Frontend::Template::GenerateBlockHooks'}->{'900-OTRSCustomContactFields-SimpleWidget'} =  {
  'AgentTicketEmail' => [
    'CustomerTable'
  ],
  'AgentTicketPhone' => [
...
$Self->{'Frontend::Module'}->{'CustomerCustomerSearch'} =  {
  'Description' => 'CustomerCustomerSearch',
  'NavBarName' => 'Ticket',
  'Title' => 'CustomerCustomerSearch'
};
$Self->{'CustomerFrontend::Module'}->{'CustomerContactSearch'} =  {
  'Description' => 'CustomerContactSearch',
  'NavBarName' => 'Ticket',
  'Title' => 'CustomerContactSearch'
};
$Self->{'CustomerFrontend::Module'}->{'CustomerCustomerSearch'} =  {
  'Description' => 'CustomerCustomerSearch',
  'NavBarName' => 'Ticket',
  'Title' => 'CustomerCustomerSearch'
};
$Self->{'Frontend::Module'}->{'AgentContactSearch'} =  {
  'Description' => 'AgentContactSearch',
  'NavBarName' => 'Ticket',
  'Title' => 'AgentContactSearch'
};
$Self->{'Ticket::Frontend::AgentTicketCustomer'}->{'DynamicField'} =  {};
$Self->{'CustomerTicket::Permission'}->{'90-CustomerTicketContact'} =  {
  'Granted' => '1',
  'Module' => 'Kernel::System::Ticket::CustomerPermission::CustomerTicketContact',
  'Required' => '0'
};
$Self->{'CustomerFrontend::NavBarModule'}->{'42-TicketContact'} =  {
  'Module' => 'Kernel::Output::HTML::NavBar::CustomerTicketContact'
};
$Self->{'Loader::Customer::CommonJS'}->{'010-OTRSCustomContactFields'} =  [
  'Core.Customer.DynamicField.Customer.js'
];
$Self->{'Loader::Customer::CommonCSS'}->{'010-OTRSCustomContactFields'} =  [
  'Core.Customer.CustomContactFields.css'
];
$Self->{'CustomerFrontend::Module'}->{'CustomerTicketContact'} =  {
  'Description' => 'View customer contact tickets',
  'NavBarName' => 'Ticket',
  'Title' => 'View customer contact tickets'
};
...
$Self->{'Frontend::Module'}->{'AdminCustomContactFields'} =  {
  'Description' => 'Admin',
  'Group' => [
    'admin'
  ],
  ...
  'Title' => 'Dynamic Fields Customer Backend GUI'
};
$Self->{'DynamicFields::Driver'}->{'Customer'} =  {
  'ConfigDialog' => 'AdminCustomContactFields',
  'DisplayName' => 'Customer',
  'ItemSeparator' => ', ',
  'Module' => 'Kernel::System::DynamicField::Driver::Customer'
};
$Self->{'Frontend::Module'}->{'AgentAppointmentTeamUser'} =  {
  'Description' => 'Team agents management screen.',
  'Group' => [
    'admin'
  ],
  'NavBar' => [
    {
      ...
      'Link' => 'Action=AgentAppointmentTeamUser',
      'LinkOption' => '',
...
$Self->{'Frontend::Module'}->{'AgentAppointmentTeam'} =  {
  'Description' => 'Team management screen.',
  'Group' => [
    'admin'
  ],
  'NavBar' => [
    {
      ...
      'Link' => 'Action=AgentAppointmentTeam',
      'LinkOption' => '',
      'Name' => 'Manage Teams',
      'NavBar' => 'Calendar',
      'Prio' => '11000',
...
$Self->{'Frontend::Module'}->{'AgentAppointmentTeamList'} =  {
  'Description' => 'Resources list.',
  'NavBarName' => '',
  'Title' => 'Team list'
};
$Self->{'Frontend::Module'}->{'AgentAppointmentResourceOverview'} =  {
  'Description' => 'Resource overview screen.',
  'Loader' => {
    'CSS' => [
  ...
  'NavBar' => [
    {
      'AccessKey' => '',
      'Block' => 'ItemArea',
      'Description' => 'Resource overview page.',
      'Link' => 'Action=AgentAppointmentResourceOverview',
      'LinkOption' => '',
...
$Self->{'NotificationView::ObjectType'}->{'Calendar'} =  {
  'FilterPrio' => '1030',
  'Hook' => '[% Translate("Calendar") | html %]:',
  'Link' => 'Action=AgentAppointmentCalendarManage;Subaction=Edit;CalendarID=[% Data.ObjectID | html %]'
};
$Self->{'NotificationView::ObjectType'}->{'Appointment'} =  {
  'FilterPrio' => '1020',
  'Hook' => '[% Translate("Appointment") | html %]:',
  'Link' => 'Action=AgentAppointmentCalendarOverview;AppointmentID=[% Data.ObjectID | html %]'
};
$Self->{'NotificationView::ObjectType'}->{'Ticket'} =  {
  'FilterPrio' => '1010',
  'Hook' => '[% Config("Ticket::Hook") | html %]',
  'Link' => 'Action=AgentTicketZoom;TicketID=[% Data.ObjectID | html %]'
};
$Self->{'NotificationView::Frontend::BulkFeature'} =  '1';
$Self->{'PreferencesGroups'}->{'NotificationViewFilterSettings'} =  {
  'Active' => '0',
  'Column' => 'Other Settings',
  'Key' => 'Column notification web view filters for Notification web view type "Small".',
  'Label' => 'Enabled filters.',
  'Module' => 'Kernel::Output::HTML::Preferences::ColumnFilters',
  'PrefKey' => 'UserFilterColumnsEnabled',
  'Prio' => '8100'
};
$Self->{'PreferencesGroups'}->{'NotificationViewSmallPageShown'} =  {
  'Active' => '0',
  'Column' => 'Other Settings',
  'Data' => {
    '10' => '10',
  ...
  'DataSelected' => '25',
  'Key' => 'Notification limit per page for Notification web view "Small"',
  'Label' => 'Notification web view "Small" Limit',
  'Module' => 'Kernel::Output::HTML::Preferences::Generic',
  'PrefKey' => 'UserNotificationViewSmallPageShown',
  'Prio' => '8000'
};
$Self->{'NotificationView::Frontend::Overview'}->{'Small'} =  {
  'Module' => 'Kernel::Output::HTML::NotificationView::Small',
  'ModulePriority' => '100',
  'Name' => 'Small',
  'NameShort' => 'S'
};
$Self->{'NotificationView::Frontend::AgentNotificationView'}->{'DefaultColumns'} =  {
  'Age' => '2',
  'Name' => '2',
  'ObjectReference' => '2',
  'ObjectType' => '2',
...
$Self->{'Frontend::Module'}->{'AgentNotificationView'} =  {
...
$Self->{'Frontend::ToolBarModule'}->{'12-NotificationWebView::AgentNotificationView'} =  {
  'AccessKey' => 'N',
...
$Self->{'Notification::Transport::NotificationView::DaysToKeep'} =  '30';
...
$Self->{'AutoComplete::Agent'}->{'DynamicFieldDatabaseSearch'} =  {
  'AutoCompleteActive' => '1',
...
$Self->{'CustomerFrontend::Module'}->{'CustomerDynamicFieldDatabaseDetails'} =  {
  'Description' => 'CustomerDynamicFieldDatabaseDetails',
  'Loader' => {
    'CSS' => [
      'DynamicFieldDatabase.css'
    ],
    'JavaScript' => [
      'Core.Agent.DynamicFieldDatabaseSearch.js'
    ]
  },
  'NavBarName' => 'Ticket',
  'Title' => 'CustomerDynamicFieldDatabaseDetails'
};
$Self->{'CustomerFrontend::Module'}->{'CustomerDynamicFieldDatabaseDetailedSearch'} =  {
  'Description' => 'CustomerDynamicFieldDatabaseDetailedSearch',
  'Loader' => {
    'CSS' => [
      'DynamicFieldDatabase.css'
    ],
  ...
  'NavBarName' => 'Ticket',
  'Title' => 'CustomerDynamicFieldDatabaseDetailedSearch'
};
$Self->{'CustomerFrontend::Module'}->{'CustomerDynamicFieldDatabaseSearch'} =  {
  'Description' => 'CustomerDynamicFieldDatabaseSearch',
  'Loader' => {
    'CSS' => [
      'DynamicFieldDatabase.css'
    ],
  ...
  'NavBarName' => 'Ticket',
  'Title' => 'CustomerDynamicFieldDatabaseSearch'
};
$Self->{'Frontend::Module'}->{'AgentDynamicFieldDatabaseSearch'} =  {
  'Description' => 'AgentDynamicFieldDatabaseSearch',
  'NavBarName' => 'Ticket',
  'Title' => 'AgentDynamicFieldDatabaseSearch'
};
$Self->{'DynamicFields::Driver'}->{'Database'} =  {
  'ConfigDialog' => 'AdminDynamicFieldDatabase',
  'DisplayName' => 'Database',
  'Module' => 'Kernel::System::DynamicField::Driver::Database'
};
$Self->{'Frontend::Module'}->{'AgentDynamicFieldDatabaseDetails'} =  {
  'Description' => 'AgentDynamicFieldDatabaseDetails',
  'Loader' => {
    'JavaScript' => [
      'Core.Agent.DynamicFieldDatabaseSearch.js'
    ]
  ...
  'NavBarName' => 'Ticket',
  'Title' => 'AgentDynamicFieldDatabaseDetails'
};
$Self->{'Frontend::Module'}->{'AgentDynamicFieldDatabaseDetailedSearch'} =  {
  'Description' => 'AgentDynamicFieldDatabaseDetailedSearch',
  'Loader' => {
    'JavaScript' => [
      'Core.Agent.DynamicFieldDatabaseSearch.js'
    ]
  ...
  'NavBarName' => 'Ticket',
  'Title' => 'AgentDynamicFieldDatabaseDetailedSearch'
};
$Self->{'Frontend::Module'}->{'AdminDynamicFieldDatabase'} =  {
  'Description' => 'Admin',
  'Group' => [
    'admin'
  ],
  'Loader' => {
    'JavaScript' => [
      'Core.Agent.Admin.DynamicField.js',
      'Core.Agent.Admin.DynamicFieldDatabase.js'
    ]
  },
  'Title' => 'Dynamic Fields Database Backend GUI'
};
$Self->{'Loader::Customer::CommonCSS'}->{'000-DynamicFieldDatabase'} =  [
  'DynamicFieldDatabase.css'
];
$Self->{'Loader::Agent::CommonCSS'}->{'000-DynamicFieldDatabase'} =  [
  'DynamicFieldDatabase.css'
];
$Self->{'Loader::Customer::CommonJS'}->{'200-DynamicFieldDatabase'} =  [
  'Core.Agent.DynamicFieldDatabaseSearch.js'
];
...
$Self->{'Loader::Agent::CommonJS'}->{'200-DynamicFieldDatabase'} =  [
  'Core.Agent.DynamicFieldDatabaseSearch.js'
];
$Self->{'SLAPreferences'}->{'FieldSelectionDialogText'} =  {
  'Block' => 'TextArea',
  'Cols' => '51',
...
$Self->{'Frontend::Output::FilterElementPost'}->{'OutputFilterPostSLASelectionDialog'} =  {
  'Module' => 'Kernel::Output::HTML::FilterElementPost::SLASelectionDialog',
  'Templates' => {
    'CustomerTicketMessage' => '1'
  }
};
$Self->{'AdminContactWithData::RunInitialWildcardSearch'} =  '1';
...
$Self->{'Frontend::Module'}->{'AgentContactWithDataSearch'} =  {
  'Description' => 'AgentContactWithDataSearch',
  'NavBarName' => 'Ticket',
  'Title' => 'AgentContactWithDataSearch'
};
$Self->{'Frontend::Output::FilterElementPost'}->{'OutputFilterPostContactWithData'} =  {
  'Module' => 'Kernel::Output::HTML::FilterElementPost::ContactWithData',
  'Templates' => {
    ...
    'AgentTicketProcess' => '1',
    'AgentTicketResponsible' => '1',
    'AgentTicketZoom' => '1',
    'ProcessManagement/ActivityDialogHeader' => '1',
    'ProcessManagement/DynamicField' => '1'
  }
};
$Self->{'Loader::Agent::CommonJS'}->{'200-DynamicFieldContactWithData'} =  [
  'Core.Agent.DynamicField.ContactWithData.js'
];
$Self->{'Frontend::Module'}->{'AdminDynamicFieldContactWithData'} =  {
  'Description' => 'Admin',
  'Group' => [
    'admin'
  ],
...
$Self->{'DynamicFields::Driver'}->{'ContactWithData'} =  {
...
$Self->{'Frontend::Template::GenerateBlockHooks'}->{'100-OTRSBusiness-ContactWithData'} =  {
  'AgentTicketZoom' => [
    'CustomerTable'
  ]
};
$Self->{'Loader::Agent::DefaultSelectedSkin'} =  'business';
$Self->{'Loader::Agent::Skin'}->{'002-business'} =  {
  'Description' => 'OTRS Business Solution™',
  'HomePage' => 'www.otrs.com',
  'InternalName' => 'business',
  'VisibleName' => 'OTRS Business Solution™'
};
$Self->{'AgentLoginLogo'} =  {
  'StyleHeight' => '50px',
  'URL' => 'skins/Agent/business/img/logo.png'
};
$Self->{'AgentLogoCustom'}->{'ivory-slim'} =  {
  ...
  'StyleTop' => '15px',
  'StyleWidth' => '300px',
  'URL' => 'skins/Agent/business/img/logo-bw.png'
};
...
$Self->{'Ticket::Frontend::MenuModule'}->{'420-Attachments'} =  {
  'Action' => 'AgentTicketAttachmentView',
  'Description' => 'Show all ticket attachments',
...
$Self->{'Frontend::Module'}->{'AgentTicketAttachmentView'} =  {
...
$Self->{'CustomerFrontend::Module'}->{'CustomerVideoChat'} =  {
...
$Self->{'ChatEngine::ChatOrder'} =  '1';
$Self->{'ChatEngine::CustomerFrontend::AgentPreferences'} =  [];
$Self->{'ChatEngine::CustomerFrontend::AgentPreferencesText'} =  'Agent Information';
$Self->{'Daemon::SchedulerCronTaskManager::Task'}->{'RemoveClosedChats'} =  {
  'Function' => 'Execute',
  'MaximumParallelInstances' => '1',
...
$Self->{'ChatEngine::ChatDecayTime'} =  '365';
$Self->{'ChatEngine::ChatTTL'} =  '24';
$Self->{'Ticket::Agent::DisplayNotificationIfUnavailable'} =  '1';
$Self->{'Frontend::NotifyModule'}->{'523-ChatPreferredChannels-Check'} =  {
  'Module' => 'Kernel::Output::HTML::Notification::ChatPreferredChannelsCheck'
};
$Self->{'Frontend::NotifyModule'}->{'513-ChatAvailability-Check'} =  {
  'Module' => 'Kernel::Output::HTML::Notification::ChatAvailabilityCheck'
};
$Self->{'Ticket::Agent::UnavailableForExternalChatsOnLogin'} =  '1';
$Self->{'Frontend::Module'}->{'AgentChatAvailability'} =  {
  'Description' => 'Chat availability',
  'Title' => 'Chat availability'
};
$Self->{'Ticket::Customer::StartChatWOTicket'} =  '1';
$Self->{'Ticket::Agent::StartChatWOTicket'} =  '1';
$Self->{'ChatEngine::DefaultChatChannel'} =  'Default channel';
$Self->{'ChatEngine::CustomerOnlineThreshold'} =  '5';
$Self->{'ChatEngine::AgentOnlineThreshold'} =  '5';
...
$Self->{'CustomerFrontend::Module'}->{'CustomerChatDownload'} =  {
...
$Self->{'QueuePreferences'}->{'ChatChannel'} =  {
  'Block' => 'Option',
  'Cols' => '50',
  'Desc' => 'Chat channel that will be used for communication related to the tickets in this queue.',
  'Label' => 'Chat Channel:',
...
$Self->{'Ticket::Agent::StartChatFromTicket'}->{'AllowChatOnlyIfCustomerAvailable'} =  '1';
$Self->{'Ticket::Customer::StartChatFromTicket'}->{'AllowChatOnlyIfAgentsAvailable'} =  '1';
$Self->{'Ticket::Agent::StartChatFromTicket'}->{'RequiredLock'} =  '0';
$Self->{'Ticket::Agent::StartChatFromTicket'}->{'PermissionLevel'} =  'ro';
$Self->{'Ticket::Customer::StartChatFromTicket'}->{'Permissions'} =  '0';
$Self->{'Ticket::Agent::StartChatFromTicket'}->{'Allowed'} =  '1';
$Self->{'Ticket::Customer::StartChatFromTicket'}->{'Allowed'} =  '1';
$Self->{'PreferencesGroups'}->{'CustomChatChannelExternal'} =  {
  'Active' => '1',
  'Column' => 'Notification Settings',
  'Desc' => 'Your selection of your preferred external chat channels. You will be notified about external chat requests in these chat channels.',
...
$Self->{'Frontend::Module'}->{'AdminChatChannel'} =  {
  'Description' => 'Admin',
  'Group' => [
    'admin'
  ],
...
$Self->{'ChatEngine::Texts::PublicFrontend::ChatCompleted'} =  'This chat is completed. You can start a new chat using the button on top of this page.';
$Self->{'ChatEngine::Texts::PublicFrontend::NotYetAccepted'} =  'Please bear with us until one of our agents is able to handle your chat request. Thank you for your patience.';
$Self->{'ChatEngine::Texts::PublicFrontend::NoAgentsAvailable'} =  'There are no chat agents available at present. Please try again later.';
$Self->{'ChatEngine::Texts::CustomerFrontend::ChatCompleted'} =  'This chat is completed. You can now close the chat window.';
$Self->{'ChatEngine::Texts::PublicInterface::ChatClosed'} =  'This chat has ended. Please leave it or it will be closed automatically.';
$Self->{'ChatEngine::Texts::CustomerFrontend::ChatClosed'} =  'This chat has ended. Please leave it or it will be closed automatically. You can download this chat.';
$Self->{'ChatEngine::Texts::CustomerFrontend::NotYetAccepted'} =  'Please bear with us until one of our agents is able to handle your chat request. Thank you for your patience.';
$Self->{'ChatEngine::Texts::CustomerFrontend::NoAgentsAvailable::AddToExisiting'} =  'There are no chat agents available at present. To add an article to the existing ticket, please click here:';
$Self->{'ChatEngine::Texts::CustomerFrontend::NoAgentsAvailable::NewTicket'} =  'There are no chat agents available at present. To create a new ticket, please click here:';
$Self->{'ChatEngine::CustomerThreshold'} =  '5';
$Self->{'ChatEngine::PublicInterface::AvailabilityCheck'} =  '1';
$Self->{'ChatEngine::CustomerFrontend::AvailabilityCheck'} =  '1';
$Self->{'ChatEngine::CustomerInterface::AllowChatChannels'} =  '1';
$Self->{'ChatEngine::PublicInterface::AllowChatChannels'} =  '1';
$Self->{'ChatEngine::DefaultAgentNameNumbers'} =  '1';
$Self->{'PublicFrontend::Module'}->{'PublicChat'} =  {
  'Description' => 'Public Chat Module',
  'Loader' => {
    'CSS' => [
      'Core.Customer.Chat.css'
    ],
    'JavaScript' => [
      'Core.Customer.Chat.js',
      'Core.Customer.Chat.js'
    ]
  },
  'NavBar' => [
...
$Self->{'Frontend::Module'}->{'AgentChatAppend'} =  {
...
$Self->{'Frontend::ToolBarModule'}->{'13-ChatAvailability'} =  {
  'AccessKey' => '',
...
$Self->{'Frontend::ToolBarModule'}->{'12-ChatRequests'} =  {
  'AccessKey' => '',
...
$Self->{'Frontend::NavBarModule'}->{'000-CustomerChat'} =  {
  'Module' => 'Kernel::Output::HTML::NavBar::AgentChat'
};
$Self->{'Frontend::Module'}->{'AgentChat'} =  {
  'Description' => 'Chat',
  'Loader' => {
    'CSS' => [
      'Core.Agent.Chat.css'
...
$Self->{'CustomerFrontend::NavBarModule'}->{'000-CustomerChat'} =  {
  'Module' => 'Kernel::Output::HTML::NavBar::CustomerChat'
};
  ...
  'NavBar' => [
    {
      ...
      'Link' => 'Action=CustomerChat;Subaction=ChatOverview',
      'LinkOption' => '',
      'Name' => 'Chats',
      'NavBar' => 'Chat',
      'Prio' => '200',
    ...
    },
    {
      ...
      'Link' => 'Action=CustomerChat;Subaction=CreateChatRequest',
...
$Self->{'ChatEngine::PermissionGroup::VideoChatAgents'} =  'users';
$Self->{'ChatEngine::PermissionGroup::ChatStartingAgents'} =  'users';
$Self->{'ChatEngine::PermissionGroup::ChatReceivingAgents'} =  'users';
$Self->{'ChatEngine::ChatDirection::AgentToAgent'} =  '1';
$Self->{'ChatEngine::ChatDirection::AgentToCustomer'} =  '1';
$Self->{'ChatEngine::ChatDirection::CustomerToAgent'} =  '1';
$Self->{'ChatEngine::ChatDirection::PublicToAgent'} =  '1';
$Self->{'ChatEngine::Active'} =  '0';
$Self->{'Loader::Customer::CommonJS'}->{'100-OTRSBusiness'} =  [
  'Core.Customer.Chat.Toolbar.js',
  'Core.VideoChat.js',
  'thirdparty/adapter.js-1.4.0/adapter.js'
];
$Self->{'Loader::Agent::CommonJS'}->{'100-OTRSBusiness'} =  [
  'Core.Agent.Chat.Toolbar.js',
  'Core.VideoChat.js',
  'thirdparty/adapter.js-1.4.0/adapter.js'
];
$Self->{'TimelineViewEnabled'} =  '1';
$Self->{'Ticket::Frontend::AgentTicketResponsible'}->{'NoteMandatory'} =  '0';
$Self->{'Ticket::Frontend::AgentTicketOwner'}->{'NoteMandatory'} =  '0';
$Self->{'ProductName'} =  'OTRS Business Solution™';
$Self->{'Ticket::Service'} =  '1';
$Self->{'Daemon::SchedulerCronTaskManager::Task'}->{'RebuildEscalationIndexOnline'} =  {
  'Function' => 'Execute',
  'MaximumParallelInstances' => '1',
...
$Self->{'Frontend::Module'}->{'AgentTicketEscalationViewWithoutSuspended'} =  {
  'Description' => 'Overview of all escalated tickets without suspend states',
  'Loader' => {
    'CSS' => [
      'Core.AllocationList.css'
    ],
  ...
  'NavBar' => [
    {
      'AccessKey' => 'e',
      'Block' => '',
      'Description' => 'Overview Escalated Tickets Without Suspend State',
      'Link' => 'Action=AgentTicketEscalationViewWithoutSuspended',
      'LinkOption' => '',
      'Name' => 'Escalation view - Without Suspend State',
      'NavBar' => 'Ticket',
      'Prio' => '121',
      'Type' => ''
    }
  ...
  'NavBarName' => 'Ticket',
  'Title' => 'Escalation view Without Suspended'
};
...
$Self->{'Ticket::CustomModule'}->{'OTRSEscalationSuspend'} =  'Kernel::System::Ticket::OTRSEscalationSuspend';
$Self->{'ITSMConfigItem::CustomSearchXMLFields'} =  {
  'Owner' => '1'
};
$Self->{'Frontend::Module'}->{'AgentITSMConfigItemCustomSearch'} =  {
  'Description' => 'Search Config Items (Custom)',
  'GroupRo' => [
    'itsm-configitem'
  ],
  'Loader' => {
  ...
  'NavBar' => [
    {
      ...
      'Block' => '',
      'Description' => 'Search Config Items (Custom)',
      'Link' => 'Action=AgentITSMConfigItemCustomSearch',
      'Name' => 'Search (Custom)',
      'NavBar' => 'Config Item',
      'Prio' => '350',
      'Type' => ''
...
$Self->{'ITSMConfigItem::TicketDynamicFieldValueMapping'} =  {
  'SLAEquipement' => {
    'AUCUN' => '0',
    'EXA-GTI 4H' => '1',
    'EXA-GTI 4H 24/7' => '7',
...
$Self->{'ITSMConfigItem::SLAField'} =  'TicketSLAName';
$Self->{'ITSMConfigItem::ServiceField'} =  'TicketServiceName';
$Self->{'ITSMConfigItem::EventModulePost'}->{'999-OTRSCIAssignmentSLA'} =  {
  'Event' => '(LinkAdd|LinkDelete)',
  'Module' => 'Kernel::System::ITSMConfigItem::Event::OTRSCIAssignmentSLA',
  'Transaction' => '0'
};
...
$Self->{'Frontend::Module'}->{'AgentAppointmentAgendaOverview'} =  {
  ...
  'Loader' => {
    ...
    'JavaScript' => [
      'thirdparty/momentjs-2.13.0/moment.min.js',
      'thirdparty/fullcalendar-3.0.1/fullcalendar.js',
      'Core.Agent.AppointmentCalendar.js'
    ]
  },
  'NavBar' => [
...
$Self->{'Frontend::Module'}->{'AgentAppointmentImport'} =  {
  'Description' => 'Import appointments screen.',
  'NavBarName' => 'Calendar',
  'Title' => 'Import Appointments'
};
$Self->{'Frontend::Module'}->{'AgentAppointmentCalendarManage'} =  {
  ...
  'Loader' => {
    ...
    'JavaScript' => [
      ...
      'Core.Agent.AppointmentCalendar.Manage.js'
    ]
  },
  'NavBar' => [
    {
      ...
      'Link' => 'Action=AgentAppointmentCalendarManage',
      'LinkOption' => '',
...
$Self->{'Ticket::EventModulePost'}->{'951-UpdateResume'} =  {
  'Event' => 'TicketDynamicFieldUpdate',
  'Module' => 'Kernel::System::Ticket::Event::APA_TicketCloseUpdateResume'
};
$Self->{'AgentCustomerInformationCenter::Backend'}->{'0070-CIC-TableauRecap'} =  {
  'Attributes' => '',
  'Block' => 'ContentLarge',
  'CacheTTLLocal' => '0.5',
  'Default' => '1',
  'Description' => 'All Contracts Subscribed',
  'Group' => 'APA-PoolManagement',
  'Limit' => '10',
  'Module' => 'Kernel::Output::HTML::Dashboard::APA_TR',
  'Permission' => 'ro',
  'Title' => 'Contracts Subscribed'
};
$Self->{'DashboardBackend'}->{'0700-TableauRecap'} =  {
  'Block' => 'ContentSmall',
  'CacheTTLLocal' => '5',
  'Default' => '0',
  'Description' => '',
...
$Self->{'Frontend::Module'}->{'APA_AdminTR'} =  {
  'Description' => 'Admin',
  'Group' => [
    'APA-ContractManagement'
  ],
  'Title' => 'TR Management'
};
$Self->{'Stats::DynamicObjectRegistration'}->{'APA_RTCDetail'} =  {
  'Module' => 'Kernel::System::Stats::Dynamic::APA_RTCDetail'
};
$Self->{'Stats::DynamicObjectRegistration'}->{'APA_RTCList'} =  {
  'Module' => 'Kernel::System::Stats::Dynamic::APA_RTCList'
};
$Self->{'Frontend::Module'}->{'APA_UpdateRTC'} =  {
  'Description' => 'RTC Update',
  'GroupRo' => [
    'APA-PoolManagement'
  ],
  'NavBarName' => 'RTC',
...
$Self->{'Frontend::Module'}->{'APA_AgentRTCZoom'} =  {
  'Description' => 'RTC Zoom',
  'GroupRo' => [
    'APA-PoolManagement'
  ],
  'NavBarName' => 'RTC',
...
$Self->{'Pool::Config'}->{'Group'} =  'APA-PoolManagement';
$Self->{'Frontend::Module'}->{'APA_AgentRTC'} =  {
  'Description' => 'RTC Area.',
  'GroupRo' => [
    'APA-PoolManagement'
  ],
  'Loader' => {
    'CSS' => [
      'thirdparty/bootstrap-3.3.7/apa-bootstrap.css',
      'thirdparty/bootstrap-switch/bootstrap-switch.css'
    ],
    'JavaScript' => [
      'thirdparty/bootstrap-3.3.7/bootstrap.min.js',
      'thirdparty/bootstrap-switch/bootstrap-switch.js'
    ]
  },
  'NavBar' => [
    {
...
$Self->{'Stats::DynamicObjectRegistration'}->{'APA_UODetail'} =  {
  'Module' => 'Kernel::System::Stats::Dynamic::APA_UODetail'
};
$Self->{'Stats::DynamicObjectRegistration'}->{'APA_UOList'} =  {
  'Module' => 'Kernel::System::Stats::Dynamic::APA_UOList'
};
$Self->{'Frontend::Module'}->{'APA_UpdateUO'} =  {
  'Description' => 'UO Update',
  'GroupRo' => [
    'APA-PoolManagement'
  ],
  'NavBarName' => 'UO Pool',
...
$Self->{'Frontend::Module'}->{'APA_AgentUOZoom'} =  {
  'Description' => 'UO Zoom',
  'GroupRo' => [
    'APA-PoolManagement'
  ],
...
$Self->{'Frontend::Output::FilterElementPost'}->{'APA_TicketUOClose'} =  {
  'Module' => 'Kernel::Output::HTML::Exaprobe::APA_TicketUOClose',
  'Templates' => {
    'AgentTicketClose' => '1'
  }
};
$Self->{'Pool::Preferences::Position'} =  'top';
$Self->{'Pool::Preferences::EmptyContractDisplay'} =  '0';
$Self->{'Frontend::Output::FilterElementPost'}->{'APA_TicketUO'} =  {
  'Module' => 'Kernel::Output::HTML::Exaprobe::APA_TicketUO',
  'Templates' => {
    'AgentTicketClose' => '1',
    'AgentTicketZoom' => '1'
  }
};
$Self->{'Frontend::Module'}->{'APA_AgentUO'} =  {
...
$Self->{'ContractManagement::Config'}->{'MailSubjectFR'} =  'Document en Attente pour la Mise en Production de l\'affaire : $Caff (Client : $Client )';
$Self->{'ContractManagement::Config'}->{'MailBodyFR'} =  'Nous sommes en attente du document : $MEP pour l\'affaire citée en objet.';
$Self->{'ContractManagement::Config'}->{'MailExpediteur'} =  '';
$Self->{'ContractManagement::Config'}->{'PasswordDBOTRS'} =  '';
$Self->{'ContractManagement::Config'}->{'UserDBOTRS'} =  '';
$Self->{'ContractManagement::Config'}->{'PasswordDBSage'} =  '';
$Self->{'ContractManagement::Config'}->{'UserDBSage'} =  '';
$Self->{'ContractManagement::Config'}->{'Group'} =  'APA-ContractManagement';
$Self->{'ContractManagement::Config::Admin'}->{'DocorAbo'} =  'Doc';
$Self->{'ContractManagement::Config::Admin'}->{'Diff2Date'} =  '5274000';
$Self->{'ContractManagement::Config::Admin'}->{'EntryDate'} =  '5274000';
$Self->{'ContractManagement::Config::Admin'}->{'CMResponsible'} =  '81';
$Self->{'ContractManagement::Config::Admin'}->{'BackupResponsible'} =  '16';
$Self->{'ContractManagement::Config::Admin'}->{'SUPResponsible'} =  '16';
$Self->{'ContractManagement::Config::Admin'}->{'RTCResponsible'} =  '16';
$Self->{'ContractManagement::Config::Admin'}->{'UOResponsible'} =  '16';
$Self->{'ContractManagement::Config::Admin'}->{'RowNumber'} =  '35';
$Self->{'ContractManagement::Config::Agent'}->{'RowNumber'} =  '35';
$Self->{'Frontend::Module'}->{'APA_DocZoom'} =  {
  'Description' => 'Doc Zoom.',
  'GroupRo' => [
    'APA-ContractManagement'
  ],
  'NavBarName' => 'MEP Management',
  'Title' => 'Zoom'
};
$Self->{'Frontend::Module'}->{'APA_AboZoom'} =  {
  'Description' => 'Abo Zoom.',
  'GroupRo' => [
    'APA-ContractManagement'
  ],
  'NavBarName' => 'MEP Management',
...
$Self->{'Frontend::Module'}->{'APA_AdminContractManagement'} =  {
  'Description' => 'MEP Admin',
  'Group' => [
    'APA-ContractManagement'
  ],
  'Loader' => {
  ...
  'NavBar' => [
    {
      'Block' => '',
      'Description' => 'MEP Admin',
      'Link' => 'Action=APA_AdminContractManagement',
      'LinkOption' => '',
      'Name' => 'MEP Admin',
      'NavBar' => 'MEP Management',
      'Prio' => '105',
      'Type' => ''
    }
  ],
...
$Self->{'Frontend::Module'}->{'APA_AgentContractManagement'} =  {
  'Description' => 'MEP Area.',
  'GroupRo' => [
    'APA-ContractManagement'
  ],
  'Loader' => {
  ...
  'NavBar' => [
    {
      'AccessKey' => 'M',
      'Block' => 'ItemArea',
      'Description' => 'MEP Management',
      'GroupRo' => [
        'APA-ContractManagement'
      ],
      'Link' => 'Action=APA_AgentContractManagement',
      'Name' => 'MEP Management',
      'NavBar' => 'MEP Management',
      'Prio' => '200',
      'Type' => 'Menu'
    ...
    {
      'Block' => '',
      'Description' => 'MEP Information Center',
      'GroupRo' => [
        'APA-ContractManagement'
      ],
      'Link' => 'Action=APA_AgentContractManagement',
      'Name' => 'MEP Information Center',
      'NavBar' => 'MEP Management',
      'Prio' => '200',
      'Type' => ''
    }
...
$Self->{'Survey::Frontend::MenuModule'}->{'025-SurveyExport'} =  {
  'Action' => 'AgentSurveyExport',
  'Description' => 'Export Survey Details',
  'Link' => 'Action=AgentSurveyExport;SurveyID=[% Data.SurveyID | uri %]',
...
$Self->{'GenericInterface::Operation::Module'}->{'User::UserGet'} =  {
...
$Self->{'ImportExport::CustomerUserImportExport::ForceCSVMappingRecreation'} =  '0';
$Self->{'CustomerUserImport::EMailDomainCustomerIDMapping'} =  {
  'oexample.com' => 'XMPLCustomerID'
};
$Self->{'CustomerUserImport::DefaultEmailAddress'} =  'dummy@localhost';
$Self->{'CustomerUserImport::DefaultCustomerID'} =  'XMPLCustomerID';
$Self->{'ImportExport::ObjectBackendRegistration'}->{'CustomerUser'} =  {
  'Module' => 'Kernel::System::ImportExport::ObjectBackend::CustomerUser',
  'Name' => 'CustomerUser'
};
$Self->{'ImportExport::CustomerCompanyImportExport::ForceCSVMappingRecreation'} =  '0';
$Self->{'ImportExport::ObjectBackendRegistration'}->{'CustomerCompany'} =  {
  'Module' => 'Kernel::System::ImportExport::ObjectBackend::CustomerCompany',
