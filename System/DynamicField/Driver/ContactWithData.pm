...
package Kernel::System::DynamicField::Driver::ContactWithData;
...
Kernel::System::DynamicField::Driver::ContactWithData
...
sub EditFieldRender {
    ...
    my $FieldClass = 'DynamicFieldContactWithData W50pc';
...
sub SearchFieldRender {
    ...
    # check and set class if necessary
    my $FieldClass = 'DynamicFieldContactWithData';
